...
all: rpm.o task.o shm.o test.o config.o worker workup workerh2 netquality 
...
netquality: tworker.o shm.o task.o rpm.o
	gcc -o networkqualityC  shm.o task.o rpm.o test.o config.o  main.c -lnghttp2 -lssl -lcrypto
